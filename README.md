...
<h3 align="center"> начинающий full-stack разработчик </h3>

- 📫 Мои контакты: **ilyinwork05@gmail.com** or [Telegram](https://t.me/Daniel_Ilyin)

Мой текущий стек и профессиональные интересы:
<ul align="left">
  <li>
  ...
  <li>
      Бэкенд: NodeJS, Express, NestJS
  </li>
  <li>
      СУБД и инструменты связанные с ними: Mongo DB, PostresSQL, Mongoose, TypeORM
  </li>
   <li>
      Инструменты проектирования и теста REST API: Postman, Swagger
  </li>
  <li>
      Linux: Ubuntu - базовые знания на уровне пользователя
  </li>
</ul>
